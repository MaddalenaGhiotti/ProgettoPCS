...
////////////////////// OPERAZIONI DI DELETE ///////////////////////
    ...
    {
        if (Triangle1->adiacentTriangles[0] == nullptr && Triangle1->adiacentTriangles[1] == nullptr && Triangle1->adiacentTriangles[2] == nullptr){return;}
        for (Triangle* triangolo : Triangle1->adiacentTriangles)
        {
            ...
            if (Output[0] != nullptr)
            {
                ...
                Triangle::SetAdiacentTriangle(*Triangle_new_1, triangolo, *OutputTriangle[0], *OutputTriangle[1]);
            }
        }
    }
